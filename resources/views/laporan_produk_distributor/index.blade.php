                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);" class="text-warning">Laporan Produk</a></li>
                            </ol>
                        </div>
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const url =
                `/admin/laporan-produk-distributor/get_data?&tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}`;
            fetch(url)
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-produk-distributor.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" +
                tanggalAkhir;
        ...
        function exportExcel() {
            ...
            var excelURL = "{{ route('laporan-produk-distributor.export-excel') }}" + "?tanggalAwal=" + tanggalAwal +
