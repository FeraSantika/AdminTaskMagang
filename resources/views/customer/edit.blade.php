    ...
    <div class="container mt-3">
        ...
        <div class="content bg-white border">
            <div class="m-5">
                ...
                <form action="{{ route('customer.update', $dtcustomer->customer_id) }}" method="POST" class="mb-3" id="customer-form"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" value="{{$dtcustomer->customer_nama}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="col-md-12 {{ $errors->has('kategori') ? 'has-error' : '' }}">
                                    <select name="kategori" id="kategori" class="form-select">
                                        @foreach ($dtkategori as $kategori)
                                            <option value="{{ $kategori->kategori_customer_id }}">{{ $kategori->kategori_customer_nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="latitude" id="latitude" class="form-control" value="{{$dtcustomer->latitude}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="alamat" class="form-label-md-6">Alamat</label>
                                <input type="text" name="alamat" id="alamat" class="form-control" value="{{$dtcustomer->customer_alamat}}">
                            </div>
                            <div class="mb-3">
                                <label for="nomor_hp" class="form-label-md-6">Nomor HP</label>
                                <input type="text" name="nomor_hp" id="nomor_hp" class="form-control" value="{{$dtcustomer->customer_nomor_hp}}">
                            </div>
                            <div class="mb-3">
                                <label for="longtitude" class="form-label-md-6">Longtitude</label>
                                <input type="text" name="longtitude" id="longtitude" class="form-control" value="{{$dtcustomer->longtitude}}">
                            </div>
                        </div>
                    </div>
