                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);" class="text-warning">Laporan Kunjungan Distributor</a>
                                </li>
                            </ol>
                        </div>
                        <h4 class="page-title">Laporan Kunjungan Distributor </h4>
                        @if (session('success'))
            ...
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="row mb-2 align-items-end">
                                    ...
                                    <input type="hidden" id="distributor" value="{{ $distributor_id }}">
                                ...
                                <table class="table table-centered w-100 table-nowrap mb-0" id="tabelkunjungan">
                                    ...
                                    <tbody>
                                        @php
                                            $rowNumber = 1;
                                        @endphp
                                        @if ($customerDistributor->count() > 0)
                                            @foreach ($customerDistributor as $item)
                                                <tr>
                                                    <td>
                                                        {{ $rowNumber }}
                                                    </td>
                                                    <td>
                                                        {{ $item->kunjungan_tanggal }}
                                                    </td>
                    ...
                    <div class="mt-3 text-center">
                        <div class="pagination">{{ $customerDistributor->links('pagination::bootstrap-4') }}</div>
                    </div>
                </div> <!-- end col -->
            </div>
            <!-- end row -->
...
@section('script')
    <script>
        function tampilkanData() {
            ...
            const url =
                `/admin/laporan-kunjungan-distributor/get_data?pilihStatus=${pilihStatus}&tanggalAwal=${tanggalAwal}&tanggalAkhir=${tanggalAkhir}&distributor=${distributor}`;
            fetch(url)
        ...
        function exportPDFWithDates() {
            ...
            var pdfURL = "{{ route('laporan-kunjungan-distributor.export-pdf') }}" + "?tanggalAwal=" + tanggalAwal +
                "&tanggalAkhir=" +
        ...
        function exportExcel() {
            ...
            if (tanggalAwalElement && tanggalAkhirElement && pilihStatusElement) {
                ...
                var excelURL = "{{ route('laporan-kunjungan-distributor.export-excel') }}" +
